...
#Export Data
export = pd.read_excel(r"C:\Users\data anylitics\Desktop\ADANI\export\Overall export.xlsx")
...
#Client Data
client = pd.read_excel(r"C:\Users\data anylitics\Desktop\ADANI\Miss Call\Client data\Missed Called client data.xlsx")
client.head()
...
client = client.rename(columns = {'New Number' : 'phone_number_dialed'})
...
Result = Result[['Date', 'phone_number_dialed', 'status_name', 'Disposition']]
Result.head()
...
StatusCount['Avg%'] = StatusCount['status_name'] / 615
...
connect1['Avg%'] = connect1['Count'] / 388
...
Notconnect2['Avg%'] = Notconnect2['Count'] / 227
...
writer = pd.ExcelWriter(r"C:\Users\data anylitics\Desktop\Akshay\Miss Call Report.xlsx", engine='xlsxwriter')
